...
async def list_money_services(
    ...
    q: Optional[str] = Query(default=None, description="Recherche texte (nom, ville, adresse)"),
...
async def get_my_wallet(current_user: TokenPayload = Depends(get_current_user)):
    """Consulter son portefeuille BurkinaSira (solde en lecture seule au Lot 1 — paiement réel en Lot 2)."""
